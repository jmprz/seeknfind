...
$completed_items = mysqli_query($con, "SELECT * FROM lost_items WHERE status='completed' UNION SELECT * FROM report_items WHERE status='completed'");
?>
...
<div class="container mt-5">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link snf_view_active" href="admin_completed.php">Completed Items</a>
        </li>
    </ul>
</div>
<div class="container mt-5">
    ...
    <div class="row">
        <?php while ($row = mysqli_fetch_assoc($completed_items)): ?>
            <div class="col-md-4">
                <div class="card mb-3">
