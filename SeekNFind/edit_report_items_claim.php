...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM report_items_claim WHERE claim_id = '$claim_id'";
...
<head>
    ...
    <title>Edit Report Items Claim</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-5">
    <h2>Edit Report Items Claim</h2>
    <form action="update_report_items_claim.php" method="post">
